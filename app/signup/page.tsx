            ...
            <div className="w-full max-w-[440px] relative z-10 transition-all duration-500 animate-slide-up">
                ...
                <div className="bg-white rounded-[2rem] p-10 shadow-soft border border-white/20">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-[#6B7C93] text-sm mt-2">Join the academic intelligence platform.</p>
                    </div>

                    {/* Reuse LoginForm or create a SignupForm. For now, we'll use a placeholder or keep it simple. */}
                    <div className="space-y-6">
                        <p className="text-center text-[#6B7C93] text-sm">Signup is currently restricted to invited researchers. Please contact administration.</p>
                        <Link href="/login" className="block">
                            <button className="w-full py-4 bg-[#1B5FA7] text-white rounded-xl font-bold shadow-lg shadow-[#1B5FA7]/20 hover:shadow-xl transition-all">
                                Back to Login
                            </button>
                        </Link>
                    </div>
                    ...
                    <div className="mt-8 pt-8 border-t border-gray-100 text-center">
                        <p className="text-sm text-[#6B7C93]">
                            Already have an account? <Link href="/login" className="text-[#1B5FA7] font-bold hover:underline">Sign in</Link>
                        </p>
                    </div>
                </div>
